<template>
  <div>
    <div class="min-h-screen">
      ...
      >
        <div class="py-6 rounded-3xl min-h-[75vh] relative">
          <div
            class="flex flex-col col-span-full gap-2 justify-between md:col-start-4 md:col-end-10 md:py-6"
          >
            <div class="text-lg font-bold text-center text-white md:text-xl">
              ตัวละครของ {{ profileState.displayName }} คือ..
            </div>
            <div class="relative mx-auto my-4 text-center lg:w-64">
              <img
      ...
      <footer class="fixed bottom-0 pb-5 w-full bg-white lg:pb-0">
